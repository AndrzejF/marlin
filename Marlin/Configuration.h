...
const bool Z_MIN_ENDSTOP_INVERTING = false; // set to true to invert the logic of the endstop. //Zmiana endstopu na optyczny
const bool X_MAX_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop.
const bool Y_MAX_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop.
const bool Z_MAX_ENDSTOP_INVERTING = false; // set to true to invert the logic of the endstop.
const bool Z_MIN_PROBE_ENDSTOP_INVERTING = false; // set to true to invert the logic of the endstop. //Zmiana endstopu na optyczny
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,500}  // X, Y, Z sprawdzone, E pozostawione bez zmian
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {82,82,4000,500}  // X i Y przeliczone na podstawie wydruku kontrolnego, Z i E pozostawione bez zmian
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {82,82,4000,714}  // X i Y przeliczone na podstawie wydruku kontrolnego, Z pozostawione bez zmian, E na podstawie rzeczywistego przesuwania filamentu
...
//#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec) było do 3.06.2016
#define DEFAULT_MAX_FEEDRATE          {200, 200, 2, 25}    // (mm/sec)
//#define DEFAULT_MAX_ACCELERATION      {3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
#define DEFAULT_MAX_ACCELERATION      {2000,2000,30,4000}    // zmienione 3.06.2016

//#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_ACCELERATION          2000    // X, Y, Z and E acceleration in mm/s^2 for printing moves // było 3000
...
#define ENCODER_STEPS_PER_MENU_ITEM 4 //Było 5 // Set according to ENCODER_PULSES_PER_STEP or your liking
